...
{
	public class ComputeShaderLinker : GPULinker, GPULinker.IComputeShader
	{
		...
		{
			LinkedDictionary[updateRate].Add(new CommonLink<bool>(shaderName, getter, SetCompBool));
		}

		public void LinkFloat(UpdateRate updateRate, string shaderName, Func<float> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<float>(shaderName, getter, SetCompFloat));
		}

		public void LinkFloatArray(UpdateRate updateRate, string shaderName, Func<float[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<float[]>(shaderName, getter, SetCompFloatArray));
		}

		public void LinkInt(UpdateRate updateRate, string shaderName, Func<int> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<int>(shaderName, getter, SetCompInt));
		}

		public void LinkIntArray(UpdateRate updateRate, string shaderName, Func<int[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<int[]>(shaderName, getter, SetCompIntArray));
		}

		public void LinkMatrix(UpdateRate updateRate, string shaderName, Func<Matrix4x4> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Matrix4x4>(shaderName, getter, SetCompMatrix));
		}

		public void LinkMatrixArray(UpdateRate updateRate, string shaderName, Func<Matrix4x4[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Matrix4x4[]>(shaderName, getter, SetCompMatrixArray));
		}

		public void LinkVector(UpdateRate updateRate, string shaderName, Func<Vector4> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Vector4>(shaderName, getter, SetCompVector));
		}

		public void LinkVectorArray(UpdateRate updateRate, string shaderName, Func<Vector4[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Vector4[]>(shaderName, getter, SetCompVectorArray));
		}

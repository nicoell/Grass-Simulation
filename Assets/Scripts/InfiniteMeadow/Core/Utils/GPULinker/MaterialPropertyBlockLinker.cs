...
{
	public class MaterialPropertyBlockLinker : GPULinker, GPULinker.IMaterialPropertyBlock
	{
		...
		{
			LinkedDictionary[updateRate].Add(new CommonLink<ComputeBuffer>(shaderName, getter, SetPropBuffer));
		}

		public void LinkColor(UpdateRate updateRate, string shaderName, Func<Color> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Color>(shaderName, getter, SetPropColor));
		}

		public void LinkFloat(UpdateRate updateRate, string shaderName, Func<float> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<float>(shaderName, getter, SetPropFloat));
		}

		public void LinkFloatArray(UpdateRate updateRate, string shaderName, Func<float[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<float[]>(shaderName, getter, SetPropFloatArray));
		}

		public void LinkFloatArray(UpdateRate updateRate, string shaderName, Func<List<float>> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<List<float>>(shaderName, getter, SetPropFloatArrayList));
		}

		public void LinkMatrix(UpdateRate updateRate, string shaderName, Func<Matrix4x4> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Matrix4x4>(shaderName, getter, SetPropMatrix));
		}

		public void LinkMatrixArray(UpdateRate updateRate, string shaderName, Func<Matrix4x4[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Matrix4x4[]>(shaderName, getter, SetPropMatrixArray));
		}

		public void LinkMatrixArray(UpdateRate updateRate, string shaderName, Func<List<Matrix4x4>> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<List<Matrix4x4>>(shaderName, getter, SetPropMatrixArrayList));
		}

		public void LinkTexture(UpdateRate updateRate, string shaderName, Func<Texture> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Texture>(shaderName, getter, SetPropTexture));
		}

		public void LinkVector(UpdateRate updateRate, string shaderName, Func<Vector4> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Vector4>(shaderName, getter, SetPropVector));
		}

		public void LinkVectorArray(UpdateRate updateRate, string shaderName, Func<Vector4[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Vector4[]>(shaderName, getter, SetPropVectorArray));
		}

		public void LinkVectorArray(UpdateRate updateRate, string shaderName, Func<List<Vector4>> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<List<Vector4>>(shaderName, getter, SetPropVectorArrayList));
		}
	}
}
...
{
	public class MaterialLinker : GPULinker, GPULinker.IMaterial
	{
		...
		{
			LinkedDictionary[updateRate].Add(new CommonLink<ComputeBuffer>(shaderName, getter, SetMatBuffer));
		}

		public void LinkColor(UpdateRate updateRate, string shaderName, Func<Color> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Color>(shaderName, getter, SetMatColor));
		}

		public void LinkColorArray(UpdateRate updateRate, string shaderName, Func<Color[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Color[]>(shaderName, getter, SetMatColorArray));
		}

		public void LinkColorArray(UpdateRate updateRate, string shaderName, Func<List<Color>> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<List<Color>>(shaderName, getter, SetMatColorArrayList));
		}

		public void LinkFloat(UpdateRate updateRate, string shaderName, Func<float> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<float>(shaderName, getter, SetMatFloat));
		}

		public void LinkFloatArray(UpdateRate updateRate, string shaderName, Func<float[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<float[]>(shaderName, getter, SetMatFloatArray));
		}

		public void LinkFloatArray(UpdateRate updateRate, string shaderName, Func<List<float>> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<List<float>>(shaderName, getter, SetMatFloatArrayList));
		}

		public void LinkInt(UpdateRate updateRate, string shaderName, Func<int> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<int>(shaderName, getter, SetMatInt));
		}

		public void LinkMatrix(UpdateRate updateRate, string shaderName, Func<Matrix4x4> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Matrix4x4>(shaderName, getter, SetMatMatrix));
		}

		public void LinkMatrixArray(UpdateRate updateRate, string shaderName, Func<Matrix4x4[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Matrix4x4[]>(shaderName, getter, SetMatMatrixArray));
		}

		public void LinkMatrixArray(UpdateRate updateRate, string shaderName, Func<List<Matrix4x4>> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<List<Matrix4x4>>(shaderName, getter, SetMatMatrixArrayList));
		}

		public void LinkTexture(UpdateRate updateRate, string shaderName, Func<Texture> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Texture>(shaderName, getter, SetMatTexture));
		}

		public void LinkTextureOffset(UpdateRate updateRate, string shaderName, Func<Vector2> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Vector2>(shaderName, getter, SetMatTextureOffset));
		}

		public void LinkTextureScale(UpdateRate updateRate, string shaderName, Func<Vector2> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Vector2>(shaderName, getter, SetMatTextureScale));
		}

		public void LinkVector(UpdateRate updateRate, string shaderName, Func<Vector4> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Vector4>(shaderName, getter, SetMatVector));
		}

		public void LinkVectorArray(UpdateRate updateRate, string shaderName, Func<Vector4[]> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<Vector4[]>(shaderName, getter, SetMatVectorArray));
		}

		public void LinkVectorArray(UpdateRate updateRate, string shaderName, Func<List<Vector4>> getter)
		{
			LinkedDictionary[updateRate].Add(new CommonLink<List<Vector4>>(shaderName, getter, SetMatVectorArrayList));
		}
	}
}
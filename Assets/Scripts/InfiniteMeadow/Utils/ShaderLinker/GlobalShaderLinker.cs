...
{
	public class GlobalShaderLinker : ShaderLinker, ShaderLinker.IShader
	{
		...
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<ComputeBuffer>(shaderName, getter, SetGlobalBuffer));
		}

		public void LinkColor(UpdateRate updateRate, string shaderName, Func<Color> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<Color>(shaderName, getter, SetGlobalColor));
		}

		public void LinkFloat(UpdateRate updateRate, string shaderName, Func<float> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<float>(shaderName, getter, SetGlobalFloat));
		}

		public void LinkFloatArray(UpdateRate updateRate, string shaderName, Func<float[]> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<float[]>(shaderName, getter, SetGlobalFloatArray));
		}

		public void LinkFloatArray(UpdateRate updateRate, string shaderName, Func<List<float>> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<List<float>>(shaderName, getter, SetGlobalFloatArrayList));
		}

		public void LinkInt(UpdateRate updateRate, string shaderName, Func<int> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<int>(shaderName, getter, SetGlobalInt));
		}

		public void LinkMatrix(UpdateRate updateRate, string shaderName, Func<Matrix4x4> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<Matrix4x4>(shaderName, getter, SetGlobalMatrix));
		}

		public void LinkMatrixArray(UpdateRate updateRate, string shaderName, Func<Matrix4x4[]> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<Matrix4x4[]>(shaderName, getter, SetGlobalMatrixArray));
		}

		public void LinkMatrixArray(UpdateRate updateRate, string shaderName, Func<List<Matrix4x4>> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<List<Matrix4x4>>(shaderName, getter, SetGlobalMatrixArrayList));
		}

		public void LinkVector(UpdateRate updateRate, string shaderName, Func<Vector4> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<Vector4>(shaderName, getter, SetGlobalVector));
		}

		public void LinkVectorArray(UpdateRate updateRate, string shaderName, Func<Vector4[]> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<Vector4[]>(shaderName, getter, SetGlobalVectorArray));
		}

		public void LinkVectorArray(UpdateRate updateRate, string shaderName, Func<List<Vector4>> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<List<Vector4>>(shaderName, getter, SetGlobalVectorArrayList));
		}

		public void LinkTexture(UpdateRate updateRate, string shaderName, Func<Texture> getter)
		{
			LinkedDictionary[updateRate].Add(new ShaderLink<Texture>(shaderName, getter, SetGlobalTexture));
		}
	}
}
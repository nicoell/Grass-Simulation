...
namespace GrassSimulation.ClassTypeReference.Editor {

	/// <summary>
	/// Custom property drawer for <see cref="ClassTypeReference"/> properties.
	/// </summary>
	[CustomPropertyDrawer(typeof(Core.Utils.ClassTypeReference))]
	...
	public sealed class ClassTypeReferencePropertyDrawer : PropertyDrawer {
		...
		private static void OnSelectedTypeName(object userData) {
			...
			s_SelectedClassRef = Core.Utils.ClassTypeReference.GetClassRef(selectedType);

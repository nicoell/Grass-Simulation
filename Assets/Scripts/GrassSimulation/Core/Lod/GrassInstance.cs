...
namespace GrassSimulation.Core.Lod
{
	...
	public class GrassInstance : ContextRequirement
	{
		...
		public GrassInstance(SimulationContext ctx) : base(ctx)
		{
			...
			Ctx.GrassSimulationComputeShader.SetTexture(Ctx.KernelPhysicsBillboardGeneration, "ParameterTexture", ParameterTexture);
			Ctx.GrassSimulationComputeShader.SetTexture(Ctx.KernelPhysicsBillboardGeneration, "GrassMapTexture", GrassMapTexture);
			Ctx.GrassSimulationComputeShader.SetTexture(Ctx.KernelSimulationSetupBillboardGeneration, "ParameterTexture", ParameterTexture);

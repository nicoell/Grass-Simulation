		...
		private void LoadTestSettings(int i)
		{
			switch (i)
			{
				case 0:
					...
					Context.Settings.GrassPerInstancemodifer = 16;
					Context.Settings.LodInstancesGeometry = 64;
					Context.Settings.LodInstancesBillboardCrossed = 32;
					Context.Settings.LodInstancesBillboardScreen = 16;
					Context.Settings.LodGeometryTransitionSegments = 2;
					Context.Settings.LodBillboardCrossedTransitionSegments = 2;
					Context.Settings.LodBillboardScreenTransitionSegments = 1;
				...
				case 1:
					...
					Context.Settings.GrassPerInstancemodifer = 16;
					Context.Settings.LodInstancesGeometry = 48;
					Context.Settings.LodInstancesBillboardCrossed = 32;
					Context.Settings.LodInstancesBillboardScreen = 16;
					Context.Settings.LodGeometryTransitionSegments = 3;
					Context.Settings.LodBillboardCrossedTransitionSegments = 2;
					Context.Settings.LodBillboardScreenTransitionSegments = 1;
				...
				case 2:
					...
					Context.Settings.GrassPerInstancemodifer = 8;
					Context.Settings.LodInstancesGeometry = 32;
					Context.Settings.LodInstancesBillboardCrossed = 16;
					Context.Settings.LodInstancesBillboardScreen = 8;
					Context.Settings.LodGeometryTransitionSegments = 2;
					Context.Settings.LodBillboardCrossedTransitionSegments = 2;
					Context.Settings.LodBillboardScreenTransitionSegments = 1;
